...
export class CursorBetrayal extends GE.ADynamicObject {
	...
	public override onStart(): void {
		const element = document.getElementById("cursor_betreyal.f1d545ae-f58e-4746-998a-243effeb900c");

		if (element != null) {
			this.element = element;
			DU.Logger.write("cursor_betreyal.f1d545ae-f58e-4746-998a-243effeb900c was found");
		} else DU.Logger.write("cursor_betreyal.f1d545ae-f58e-4746-998a-243effeb900c are not found", 30);
	}
